...
from tensorflow.keras.applications import MobileNet, VGG19, InceptionResNetV2, InceptionV3, MobileNetV2, NASNetLarge
...
from tensorflow.keras.applications.nasnet import preprocess_input as NASNetLarge_preprocess_input
